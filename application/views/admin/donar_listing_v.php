...
<a href="<?php echo admin_url('what_we_do/add_donation');?>"><font size="+2" color="#26b7ee">Add Donation Info</font></a>
</div>
...
<form id="mainform" action="">
	<table border="0" width="100%" id="product-table">
		...
		<?php if($total_donars > 0) : ?>
			<?php foreach($donars as $donar) : ?>
				
				<td><input  type="checkbox"/></td>
                 <td><?php echo $donar->cause_title;?></td>
				<td><?php echo $donar->first_name;?></td>
				<td><?php echo $donar->last_name;?></td>
               
                <td><?php echo $donar->email;?></td>
				<td class="options-width"><a href="<?php echo action_link('edit_donation', $donar->donar_id);?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo action_link('donation_delete', $donar->donar_id);?>" title="Delete" class="icon-2 info-tooltip delete_link"></a></td>
			  </tr>
			<?php endforeach; ?>
		<?php else: ?>
