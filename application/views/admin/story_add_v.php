...
<table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%">
	<tr valign="top">
		<td colspan="3">
			<div id="step-holder">
				...
				<div class="step-dark-left"><a href="javascript:;">Story Details</a></div>
	...
	<tr>
		<th width="18%" valign="top">Title:</th>
	  	<td width="39%">
	  		<input type="text" name="title" class="inp-form required" value="<?php if($isEdit) echo $story->title;?>" />
		</td>
		<td width="43%"></td>
	</tr>
	<tr>
		...
		<td>
			...
			<input type="hidden" name="prev_image" value="<?php if($isEdit) echo $story->image;?>" />
			<div><em><?php if($isEdit) echo $story->image;?></em></div>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td width="60%">
        	<textarea name="detail" id="detail" rows="8" cols="80" class="ckeditor"><?php if($isEdit) echo $story->detail;?></textarea>
        </td>
    </tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input type="submit" name="submit_story" value="submitInfo" class="form-submit" />
