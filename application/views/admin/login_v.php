...
<!--  jquery core -->
<script src="<?php echo config_item('admin_js');?>jquery/jquery-1.4.1.min.js" type="text/javascript"></script>
...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login" style="margin-bottom:40px;">
	...
	<!--  start login-inner -->
	<div id="login-inner">
	<div class="red_left"><?php if($error = $this->session->flashdata('error_message')) echo $error;?></div>
	<form method="post">
		<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<th>Username</th>
			<td><input type="text" name="login_username" class="login-inp" /></td>
		</tr>
		<tr>
			<th>Password</th>
			<td><input type="password" name="login_pass" value=""  onfocus="this.value=''" class="login-inp" /></td>
		</tr>
		<tr>
			<th></th>
		...
		<tr>
			<th></th>
			<td><input type="submit" class="submit-login" name="submit_login_info" /></td>
		</tr>
		</table>
	</form>	
	</div>
