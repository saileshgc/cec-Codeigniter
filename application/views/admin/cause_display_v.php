...
<a href="<?php echo admin_url('donation/add');?>"><font size="+2" color="#26b7ee">Add Cause</font></a>
</div>
...
<form id="mainform" action="">
	<table border="0" width="100%" id="product-table">
		<tr>
			...
			<th class="table-header-repeat"><a>Details:</a></th>
			
			<th class="table-header-options"><a>Options</a></th>
		</tr>
		<?php if($total_cause > 0) : ?>
			<?php foreach($causes as $cause) : ?>
				
				<td><input  type="checkbox"/></td>
				<td><?php echo $cause->title;?></td>
				<td><?php echo $cause->detail;?></td>
				<td class="options-width"><a href="<?php echo action_link('edit', $cause->cause_id);?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo action_link('delete', $cause->cause_id);?>" title="Delete" class="icon-2 info-tooltip delete_link"></a></td>
			  </tr>
			<?php endforeach; ?>
		<?php else: ?>
			...
			<tr>
				<td class="yellow-left">No Cause have been found.</td>
