...
<a href="<?php echo admin_url('what_we_do/add_story');?>"><font size="+2" color="#26b7ee">Add Story</font></a>
</div>
...
<form id="mainform" action="">
	<table border="0" width="100%" id="product-table">
		<tr>
			...
			<th class="table-header-repeat"><a>Detail:</a></th>
		...
		<?php if($total_stories > 0) : ?>
			<?php foreach($stories as $story) : ?>
				...
				<td><?php echo $story->detail;?></td>
				
				<td class="options-width"><a href="<?php echo action_link('edit_story', $story->story_id);?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo action_link('delete_story', $story->story_id);?>" title="Delete" class="icon-2 info-tooltip delete_link"></a></td>
			  </tr>
			<?php endforeach; ?>
		<?php else: ?>
			...
			<tr>
				<td class="yellow-left">No stories have been found.</td>
