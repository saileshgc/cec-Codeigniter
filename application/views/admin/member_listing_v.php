...
<a href="<?php echo admin_url('what_we_do/add_member');?>"><font size="+2" color="#26b7ee">Add Member</font></a>
</div>
...
<form id="mainform" action="">
	<table border="0" width="100%" id="product-table">
		<tr>
			...
			<th class="table-header-repeat"><a>Member Name:</a></th>
		...
		<?php if($total_members > 0) : ?>
			<?php foreach($members as $member) : ?>
				...
				<td class="options-width"><a href="<?php echo action_link('edit_member', $member->member_id);?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo action_link('delete_member', $member->member_id);?>" title="Delete" class="icon-2 info-tooltip delete_link"></a></td>
			  </tr>
			<?php endforeach; ?>
		<?php else: ?>
			...
			<tr>
				<td class="yellow-left">No members have been found.</td>
