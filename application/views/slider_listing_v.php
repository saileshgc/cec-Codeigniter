...
<a href="<?php echo admin_url('what_we_do/add_member');?>"><font size="+2" color="#26b7ee">Add Slider Images</font></a>
</div>
	...
	<table border="0" width="100%" id="product-table">
		...
		<?php if($total_members > 0) : ?>
			<?php foreach($slides as $slide) : ?>
				...
				<td class="options-width"><a href="<?php echo action_link('edit_member', $slide->id);?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo action_link('delete_member', $slide->id);?>" title="Delete" class="icon-2 info-tooltip delete_link"></a></td>
			  </tr>
			<?php endforeach; ?>
		<?php else: ?>
